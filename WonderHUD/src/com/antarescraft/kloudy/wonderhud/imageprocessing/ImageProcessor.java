...
public class ImageProcessor 
{
	...
	public static String[][] processingErrorLines()
	{
		...
		lines[0][0] = "§4§lThere was an error when processing your image";
		lines[0][1] = "Images must be put in the folder: §e§oplugins/WonderHUD/images";
		lines[0][2] = "Did you spell the name of the image correctly?";
